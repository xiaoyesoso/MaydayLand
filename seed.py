...
CONCERTS = [
    {'id': 'c001', 'city': '北京', 'venue': '国家体育场（鸟巢）',
     ...
     'posterId': 1015,
     'highlight': '5525+2 回到那一天 · 连开 12 场累计 55 场鸟巢演出，刷新华语乐团纪录。斥资近 9000 万打造侏罗纪世界，25 只恐龙飞天遁地。场馆周边五迷角落密集，水立方胡萝卜麦克风仅 0.5km。',
     'lat': 39.9920, 'lng': 116.3970, 'concertDate': '2026-05-18'},
    {'id': 'c002', 'city': '台北', 'venue': '台北大巨蛋',
     'dateText': '2026.07.03 / 04 / 05 / 08 / 10 / 11 / 12', 'status': 'ongoing',
     'statusLabel': '热演中', 'posterId': 1018,
     'highlight': '五月天创最快重返大巨蛋纪录！7/3 首场陈绮贞惊喜同台，重现《第 168 场演唱会》；7/5 回顾《十万青年站出来》并重现《爱情万岁》专辑封面照。7/8、10、11、12 继续嗨唱。',
     'lat': 25.0597, 'lng': 121.5500, 'concertDate': '2026-07-03'},
    {'id': 'c003', 'city': '长沙', 'venue': '长沙 IFS',
     'dateText': '2026.05.23 起', 'status': 'ongoing', 'statusLabel': '进行中',
     'posterId': 1044,
     'highlight': 'STAYREAL MOJO IN BLOOM 全国首展，11 米长沙限定卜卜全球首展，三大沉浸式展区。臭豆腐卜卜周边每日限量发售中。',
...
NEWS = [
    {'id': 'n001', 'title': '五月天创最快重返大巨蛋纪录',
     'summary': '5525+2《回到那一天》7/3 首场登陆台北大巨蛋，陈绮贞惊喜同台，重现《第 168 场演唱会》，首场彩蛋满到溢出',
     'type': 'news', 'typeLabel': '资讯', 'time': '今天 10:15'},
    {'id': 'n002', 'title': '台北站重现《爱情万岁》专辑封面照',
     'summary': '7/5 五月天与你回顾《十万青年站出来》巡回演唱会，重现《爱情万岁》专辑封面照，12255 天音乐旅程继续',
     'type': 'news', 'typeLabel': '资讯', 'time': '昨天 22:40'},
    {'id': 'n003', 'title': '五月天 x 王嘉尔 x 阿信《Alive》',
     'summary': '2026 百事可乐品牌主题曲《Alive》上线，五月天阿信与王嘉尔携手，渴望就可能',
     'type': 'music', 'typeLabel': '新歌', 'time': '昨天 14:20'},
    {'id': 'n004', 'title': '鸟巢 55 场传奇收官',
     'summary': '5525+2 北京鸟巢站 4/30-5/18 连开 12 场，累计 55 场鸟巢演出，550 万歌迷共创摇滚万岁新纪录',
     'type': 'news', 'typeLabel': '资讯', 'time': '3 天前 09:30'},
    {'id': 'n005', 'title': '《如烟》《后来的我们》新版 Stage Video',
     'summary': '周深 x 五月天《如烟》5525+2 版、宋雨琦 x 五月天《后来的我们》5525 版 Official Stage Video 正式上线',
     'type': 'music', 'typeLabel': 'MV', 'time': '4 天前 16:55'},
]
